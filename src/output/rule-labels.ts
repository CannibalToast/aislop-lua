const RULE_LABELS: Record<string, string> = {
	...
	"ai-slop/lua-print-debug": "print() left in Lua code",
	"ai-slop/lua-global-assign": "Global variable assignment",
	"ai-slop/lua-version-goto": "goto requires newer Lua",
	"ai-slop/lua-version-label": "goto label requires newer Lua",
	"ai-slop/lua-version-integer-division": "Floor division requires newer Lua",
	"ai-slop/lua-version-bitwise": "Bitwise operators require newer Lua",
	"ai-slop/lua-version-const": "const requires newer Lua",
	"ai-slop/lua-version-close": "to-be-closed requires newer Lua",
	"ai-slop/lua-version-declare": "declare requires newer Lua",
	"ai-slop/lua-version-warn": "warn() requires newer Lua",
	"ai-slop/lua-version-string-pack": "string.pack requires newer Lua",
	"ai-slop/lua-version-utf8": "utf8 library requires newer Lua",
	"ai-slop/lua-version-table-create": "table.create requires newer Lua",
	"ai-slop/lua-version-table-move": "table.move requires newer Lua",
	"ai-slop/lua-version-table-unpack": "table.unpack requires newer Lua",
	"ai-slop/lua-version-env": "_ENV requires newer Lua",
	"ai-slop/lua-version-len": "length operator requires newer Lua",
	"ai-slop/lua-version-loadstring": "loadstring is deprecated",
	"ai-slop/lua-version-setfenv": "setfenv is removed",
	"ai-slop/lua-version-getfenv": "getfenv is removed",
	"ai-slop/lua-version-module": "module() is deprecated",
	"ai-slop/lua-version-bit32": "bit32 is deprecated",
	"ai-slop/lua-version-unpack-global": "global unpack is deprecated",
	"ai-slop/lua-version-math-atan2": "math.atan2 is deprecated",
	"ai-slop/lua-version-math-pow": "math.pow is deprecated",
	"ai-slop/lua-version-math-mod": "math.mod is deprecated",
	"ai-slop/lua-version-gfind": "string.gfind is deprecated",
	"ai-slop/lua-version-table-getn": "table.getn is removed",
	"ai-slop/lua-version-table-setn": "table.setn is removed",
	"ai-slop/lua-version-table-maxn": "table.maxn is removed",
	"ai-slop/lua-version-table-foreach": "table.foreach is removed",
	"ai-slop/lua-version-package-loaders": "package.loaders is renamed",
	"ai-slop/lua-version-package-searchers": "package.searchers requires newer Lua",
	"ai-slop/lua-version-table-pack": "table.pack requires newer Lua",
	"ai-slop/lua-version-loadlib": "loadlib is deprecated",
	"ai-slop/lua-version-math-log10": "math.log10 is deprecated",
	"ai-slop/lua-version-math-ldexp": "math.ldexp is deprecated",
	"ai-slop/lua-version-math-frexp": "math.frexp is deprecated",
	"ai-slop/lua-version-math-hyperbolic": "hyperbolic math is removed",
	"ai-slop/lua-version-debug-fenv": "debug.getfenv is removed",
	...
	"security/lua-load": "load()/loadstring() usage",
...
const RULE_DESCRIPTIONS: Record<string, string> = {
	...
	"ai-slop/lua-print-debug": "Debug print() was left in Lua source.",
	"ai-slop/lua-global-assign": "Assignment creates a global instead of a local.",
	"ai-slop/lua-version-goto": "goto is not available in the project's Lua target.",
	"ai-slop/lua-version-label": "goto labels are not available in the project's Lua target.",
	"ai-slop/lua-version-integer-division":
		"Floor division is not available in the project's Lua target.",
	"ai-slop/lua-version-bitwise": "Bitwise operators are not available in the project's Lua target.",
	"ai-slop/lua-version-const": "const variables are not available in the project's Lua target.",
	"ai-slop/lua-version-close":
		"to-be-closed variables are not available in the project's Lua target.",
	"ai-slop/lua-version-declare": "Global declare is not available in the project's Lua target.",
	"ai-slop/lua-version-warn": "warn() is not available in the project's Lua target.",
	"ai-slop/lua-version-string-pack": "Binary string packing needs Lua 5.3+.",
	"ai-slop/lua-version-utf8": "Built-in UTF-8 helpers need Lua 5.3+.",
	"ai-slop/lua-version-table-create": "table.create needs Lua 5.5+.",
	"ai-slop/lua-version-table-move": "table.move needs Lua 5.3+.",
	"ai-slop/lua-version-table-unpack": "table.unpack is too new for the project's Lua target.",
	"ai-slop/lua-version-env": "_ENV is not available in the project's Lua target.",
	"ai-slop/lua-version-len": "The # length operator needs Lua 5.1+.",
	"ai-slop/lua-version-loadstring": "loadstring should be load on Lua 5.2+.",
	"ai-slop/lua-version-setfenv": "setfenv was removed in Lua 5.2.",
	"ai-slop/lua-version-getfenv": "getfenv was removed in Lua 5.2.",
	"ai-slop/lua-version-module": "module() should be replaced with return/require.",
	"ai-slop/lua-version-bit32": "bit32 should be native bitwise operators on Lua 5.3+.",
	"ai-slop/lua-version-unpack-global": "unpack should be table.unpack on Lua 5.2+.",
	"ai-slop/lua-version-math-atan2": "math.atan2 should be math.atan on Lua 5.3+.",
	"ai-slop/lua-version-math-pow": "math.pow should use the ^ operator on Lua 5.3+.",
	"ai-slop/lua-version-math-mod": "math.mod should use % on Lua 5.1+.",
	"ai-slop/lua-version-gfind": "string.gfind was renamed to string.gmatch in Lua 5.1.",
	"ai-slop/lua-version-table-getn": "table.getn was removed in Lua 5.2.",
	...
	"ai-slop/lua-version-math-log10": "math.log10 should be math.log(x, 10) on Lua 5.3+.",
	"ai-slop/lua-version-math-ldexp": "math.ldexp should be x * 2.0^exp on Lua 5.3+.",
	"ai-slop/lua-version-math-frexp": "math.frexp is not in the Lua 5.4 standard library.",
	"ai-slop/lua-version-math-hyperbolic":
		"math.cosh/sinh/tanh are not in the Lua 5.4 standard library.",
	"ai-slop/lua-version-debug-fenv": "debug.getfenv/setfenv were removed in Lua 5.2.",
	...
	"security/lua-load": "Dynamic Lua loading can execute attacker-controlled code.",
	...
	"lua-formatting": "Lua file needs StyLua formatting.",
};
