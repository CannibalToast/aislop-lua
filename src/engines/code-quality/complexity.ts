...
const checkFileComplexity = (
	...
	for (const fn of analyzeFunctions(content, ext)) {
		appendAll(diagnostics, checkFunctionDiagnostics(relativePath, fn, limits, ext));
	}
...
export const checkComplexity = async (context: EngineContext): Promise<Diagnostic[]> => {
	...
	for (const filePath of files) {
		...
		appendAll(diagnostics, checkFileComplexity(filePath, context.rootDirectory, limits));
	}
